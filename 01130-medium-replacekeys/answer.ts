...
type ReplaceKeys<U, T, Y, S = U> = U extends U ? { [P in keyof S]: P extends T ? P extends keyof Y ? Y[P] : never : S[P] } : never

type B = ReplaceKeys<Nodes, 'name' | 'flag', { name: number; flag: string }>
