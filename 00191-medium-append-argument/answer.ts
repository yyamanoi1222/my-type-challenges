...
type MyArgType<T> = T extends (...args: infer U) => any ? U : never
type MyReturn<T> = T extends (...args: any[]) => infer U ? U : never

type AppendArgument<Fn, A> = (...args: [...MyArgType<Fn>, A]) => MyReturn<Fn>
