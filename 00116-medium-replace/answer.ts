...
type Replace<S extends string, From extends string, To extends string> = S extends `${infer P}${From}${infer B}`
? From extends '' ? S : `${P}${To}${B}`
: S

/*
type Replace<S extends string, From extends string, To extends string> = S extends '' ? S
 : S extends `${From}${infer U}`
 ? `${To}${U}`
 : S extends `${infer K}${From}${infer U}` ? `${K}${To}${U}`
 : S extends `${infer U}${From}` ? `${U}${To}` : S
*/
